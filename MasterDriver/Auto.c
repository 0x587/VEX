...
#pragma config(MotorPidSetting,  port8,  75, 10, 1000, 10, 10,   28, 100, 120)
#pragma config(MotorPidSetting,  port9,  75, 10, 1000, 10, 10,   28, 100, 120)
...
task main()
{
	...
	setMotorTarget(RightWheel, BackPlace,110 + VoltageErroe,false);
	waitUntil(getMotorTargetCompleted(LeftWheel)& getMotorTargetCompleted(RightWheel));
