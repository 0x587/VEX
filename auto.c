#pragma config(Sensor, dgtl1,  left_encode,    sensorQuadEncoder)
#pragma config(Sensor, dgtl3,  right_encode,   sensorQuadEncoder)
#pragma config(Sensor, dgtl5,  cj,             sensorSONAR_mm)
#pragma config(Motor,  port1,           left_light,    tmotorVexFlashlight, openLoop, reversed)
#pragma config(Motor,  port2,           right_qh,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           left_qh,       tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           right_center,  tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           left_center,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           gl_motor,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           dt_motor,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           dp1,           tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           dp2,           tmotorVex393_MC29, openLoop)
